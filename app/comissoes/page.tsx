      ...
      <div className="relative lg:ml-60" style={{ zIndex: 1 }}>
        ...
        <main className="mx-auto max-w-[1400px] px-6 py-8 lg:px-8">
          ...
          <div className="flex gap-2 mb-5">
            <button onClick={() => setAba('vendas')} className="flex items-center gap-2 rounded-xl px-4 py-2.5 text-xs font-semibold transition-all" style={{ background: aba === 'vendas' ? 'rgba(212,175,55,0.18)' : 'rgba(255,255,255,0.05)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', border: `1px solid ${aba === 'vendas' ? 'var(--accent)' : 'rgba(255,255,255,0.08)'}`, color: aba === 'vendas' ? 'var(--accent)' : 'var(--muted-color)', boxShadow: aba === 'vendas' ? '0 4px 16px rgba(212,175,55,0.15)' : 'none' }}><DollarSign size={14} />Vendas</button>
            {ehGestao && (<>
            <button onClick={() => setAba('mapa')} className="flex items-center gap-2 rounded-xl px-4 py-2.5 text-xs font-semibold transition-all" style={{ background: aba === 'mapa' ? 'rgba(212,175,55,0.18)' : 'rgba(255,255,255,0.05)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', border: `1px solid ${aba === 'mapa' ? 'var(--accent)' : 'rgba(255,255,255,0.08)'}`, color: aba === 'mapa' ? 'var(--accent)' : 'var(--muted-color)', boxShadow: aba === 'mapa' ? '0 4px 16px rgba(212,175,55,0.15)' : 'none' }}><FileText size={14} />Mapa de Comissão</button>
            <button onClick={() => setAba('calculo')} className="flex items-center gap-2 rounded-xl px-4 py-2.5 text-xs font-semibold transition-all" style={{ background: aba === 'calculo' ? 'rgba(212,175,55,0.18)' : 'rgba(255,255,255,0.05)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', border: `1px solid ${aba === 'calculo' ? 'var(--accent)' : 'rgba(255,255,255,0.08)'}`, color: aba === 'calculo' ? 'var(--accent)' : 'var(--muted-color)', boxShadow: aba === 'calculo' ? '0 4px 16px rgba(212,175,55,0.15)' : 'none' }}><Calculator size={14} />Cálculo de Comissão</button>
            <button onClick={() => setAba('config')} className="flex items-center gap-2 rounded-xl px-4 py-2.5 text-xs font-semibold transition-all" style={{ background: aba === 'config' ? 'rgba(212,175,55,0.18)' : 'rgba(255,255,255,0.05)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', border: `1px solid ${aba === 'config' ? 'var(--accent)' : 'rgba(255,255,255,0.08)'}`, color: aba === 'config' ? 'var(--accent)' : 'var(--muted-color)', boxShadow: aba === 'config' ? '0 4px 16px rgba(212,175,55,0.15)' : 'none' }}><Settings size={14} />Configurar padrão</button>
            <button onClick={() => setAba('ranking')} className="flex items-center gap-2 rounded-xl px-4 py-2.5 text-xs font-semibold transition-all" style={{ background: aba === 'ranking' ? 'rgba(212,175,55,0.18)' : 'rgba(255,255,255,0.05)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', border: `1px solid ${aba === 'ranking' ? 'var(--accent)' : 'rgba(255,255,255,0.08)'}`, color: aba === 'ranking' ? 'var(--accent)' : 'var(--muted-color)', boxShadow: aba === 'ranking' ? '0 4px 16px rgba(212,175,55,0.15)' : 'none' }}><TrendingUp size={14} />Ranking de Faturamento</button>
            </>)}
          </div>
